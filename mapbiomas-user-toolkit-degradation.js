...
// datasets organizados em memoria
var name_bordas_area = 'Bordas de 30 a 1000m';
var bordas_area = ee.Image('projects/mapbiomas-workspace/DEGRADACAO/COLECAO/BETA/PROCESS/edge_area/edge_1000m_v3').multiply(0).unmask()
...
var visParams_bordas_area = {
    min: 0,
    max: 8,
    palette: ['#55604B','#FF0001','#32CD32','#19B06F','#6FA8DC','#0B5394','#A64D79','#F54CA9'],
};

var band_bordas_area = 'edge_1000m_';


var legend_bordas_area = [
...
// classes de area borda

var name_classes_de_tamanho = 'Tamanho do fragmentos (≤ 3 a 75 ha)';
var classes_de_tamanho = ee.Image('projects/mapbiomas-workspace/DEGRADACAO/COLECAO/BETA/PROCESS/patch_size/size_75ha_v3').multiply(0).unmask()
...
var visParams_tamanho = {
  min: 0,
  max: 6,
  palette: ['#aaaaaa','#E50C08', '#FFAA5F','#32CD32','#19B06F','#6FA8DC','#0B5394'],
  bands: 'size_75ha_',
};
var legend_tamanho = [
    // ≥
...
// classes de distancias de isolamento
var natural_mask_maior100ha = ee.Image('projects/mapbiomas-workspace/DEGRADACAO/ISOLATION/BR_Distance/natural_mask_maior100ha_v5_85_22');

var distancias_dos_fragmentos_de_ate_25ha_das_areas_nativas_com_mais_de_100ha = natural_mask_maior100ha
  .multiply(0).unmask()
  .blend(natural_mask_maior100ha.gte(1)) // ORIGEM/SOURCE
  .blend(ee.Image('projects/mapbiomas-workspace/DEGRADACAO/ISOLATION/nat_uso_frag25__dist20k__100_v6_85_22').gte(1).multiply(4)) // classes de cobertura nativa até 20 km de distancia
  .blend(ee.Image('projects/mapbiomas-workspace/DEGRADACAO/ISOLATION/nat_uso_frag25__dist10k__100_v6_85_22').gte(1).multiply(3)) //  classes de cobertura nativa até 10 km de distancia
  .blend(ee.Image('projects/mapbiomas-workspace/DEGRADACAO/ISOLATION/nat_uso_frag25__dist05k__100_v6_85_22').gte(1).multiply(2)); //  classes de cobertura nativa até 05 km de distancia
  
// Map.addLayer(dstnc_trgt_25ha_src_100ha.mod(100).int8().randomVisualizer())

var distancias_dos_fragmentos_de_ate_50ha_das_areas_nativas_com_mais_de_100ha = natural_mask_maior100ha
  .multiply(0).unmask()
  .blend(natural_mask_maior100ha.gte(1))
  .blend(ee.Image('projects/mapbiomas-workspace/DEGRADACAO/ISOLATION/nat_uso_frag50__dist20k__100_v6_85_22').gte(1).multiply(4))
  .blend(ee.Image('projects/mapbiomas-workspace/DEGRADACAO/ISOLATION/nat_uso_frag50__dist10k__100_v6_85_22').gte(1).multiply(3))
  .blend(ee.Image('projects/mapbiomas-workspace/DEGRADACAO/ISOLATION/nat_uso_frag50__dist05k__100_v6_85_22').gte(1).multiply(2));

var natural_mask_maior500ha = ee.Image('projects/mapbiomas-workspace/DEGRADACAO/ISOLATION/BR_Distance/natural_mask_maior500ha_v5_85_22');

var distancias_dos_fragmentos_de_ate_25ha_das_areas_nativas_com_mais_de_500ha = natural_mask_maior100ha
  .multiply(0).unmask()
  .blend(natural_mask_maior100ha.gte(1))
  .blend(ee.Image('projects/mapbiomas-workspace/DEGRADACAO/ISOLATION/nat_uso_frag25__dist05k__500_v6_85_22').gte(1).multiply(4))
  .blend(ee.Image('projects/mapbiomas-workspace/DEGRADACAO/ISOLATION/nat_uso_frag25__dist10k__500_v6_85_22').gte(1).multiply(3))
  .blend(ee.Image('projects/mapbiomas-workspace/DEGRADACAO/ISOLATION/nat_uso_frag25__dist20k__500_v6_85_22').gte(1).multiply(2));

var distancias_dos_fragmentos_de_ate_50ha_das_areas_nativas_com_mais_de_500ha = natural_mask_maior100ha
  .multiply(0).unmask()
  .blend(natural_mask_maior100ha.gte(1))
  .blend(ee.Image('projects/mapbiomas-workspace/DEGRADACAO/ISOLATION/nat_uso_frag50__dist05k__500_v6_85_22').gte(1).multiply(4))
  .blend(ee.Image('projects/mapbiomas-workspace/DEGRADACAO/ISOLATION/nat_uso_frag50__dist10k__500_v6_85_22').gte(1).multiply(3))
  .blend(ee.Image('projects/mapbiomas-workspace/DEGRADACAO/ISOLATION/nat_uso_frag50__dist20k__500_v6_85_22').gte(1).multiply(2));

var distancias_dos_fragmentos_de_ate_100ha_das_areas_nativas_com_mais_de_500ha = natural_mask_maior100ha
  .multiply(0).unmask()
  .blend(natural_mask_maior100ha.gte(1))
  .blend(ee.Image('projects/mapbiomas-workspace/DEGRADACAO/ISOLATION/nat_uso_frag100__dist05k__500_v6_85_22').gte(1).multiply(4))
  .blend(ee.Image('projects/mapbiomas-workspace/DEGRADACAO/ISOLATION/nat_uso_frag100__dist10k__500_v6_85_22').gte(1).multiply(3))
  .blend(ee.Image('projects/mapbiomas-workspace/DEGRADACAO/ISOLATION/nat_uso_frag100__dist20k__500_v6_85_22').gte(1).multiply(2));

var natural_mask_maior1000ha = ee.Image('projects/mapbiomas-workspace/DEGRADACAO/ISOLATION/BR_Distance/natural_mask_maior1000ha_v5_85_22');

var distancias_dos_fragmentos_de_ate_25ha_das_areas_nativas_com_mais_de_1000ha = natural_mask_maior100ha
  .multiply(0).unmask()
  .blend(natural_mask_maior100ha.gte(1))
  .blend(ee.Image('projects/mapbiomas-workspace/DEGRADACAO/ISOLATION/nat_uso_frag25__dist05k__1000_v6_85_22').gte(1).multiply(4))
  .blend(ee.Image('projects/mapbiomas-workspace/DEGRADACAO/ISOLATION/nat_uso_frag25__dist10k__1000_v6_85_22').gte(1).multiply(3))
  .blend(ee.Image('projects/mapbiomas-workspace/DEGRADACAO/ISOLATION/nat_uso_frag25__dist20k__1000_v6_85_22').gte(1).multiply(2));

var distancias_dos_fragmentos_de_ate_50ha_das_areas_nativas_com_mais_de_1000ha = natural_mask_maior100ha
  .multiply(0).unmask()
  .blend(natural_mask_maior100ha.gte(1))
  .blend(ee.Image('projects/mapbiomas-workspace/DEGRADACAO/ISOLATION/nat_uso_frag50__dist05k__1000_v6_85_22').gte(1).multiply(4))
  .blend(ee.Image('projects/mapbiomas-workspace/DEGRADACAO/ISOLATION/nat_uso_frag50__dist10k__1000_v6_85_22').gte(1).multiply(3))
  .blend(ee.Image('projects/mapbiomas-workspace/DEGRADACAO/ISOLATION/nat_uso_frag50__dist20k__1000_v6_85_22').gte(1).multiply(2));

var distancias_dos_fragmentos_de_ate_100ha_das_areas_nativas_com_mais_de_1000ha = natural_mask_maior100ha
  .multiply(0).unmask()
  .blend(natural_mask_maior100ha.gte(1))
  .blend(ee.Image('projects/mapbiomas-workspace/DEGRADACAO/ISOLATION/nat_uso_frag100__dist05k__1000_v6_85_22').gte(1).multiply(4))
  .blend(ee.Image('projects/mapbiomas-workspace/DEGRADACAO/ISOLATION/nat_uso_frag100__dist10k__1000_v6_85_22').gte(1).multiply(3))
  .blend(ee.Image('projects/mapbiomas-workspace/DEGRADACAO/ISOLATION/nat_uso_frag100__dist20k__1000_v6_85_22').gte(1).multiply(2));

var visParams_distancias = {
  min:0,
  max:4,
  palette: ['#aaaaaa','#414927','#FFAA5F', '#FF0001','#F54CA9'],
  bands:'frag2022',
};

var legend_distancias = [
  {value:0, label:'Não observado'},
  {value:1, label:'Área fonte'},
  {value:2, label:'Até 05 km de distancia'},
  {value:3, label:'Até 10 km de distancia'},
  {value:4, label:'Até 20 km de distancia'},
];
    ...
    options: {
        ...
        collections: {
            ...
            'degradation BETA: patch size': {
                'assets': {
                  'classes_de_tamanho':classes_de_tamanho,
            ...
            'degradation BETA: patch isolation': {
                'assets': {
                  'D_fragmentos_ate_25ha_de_fontes_com_mais_de_100ha':distancias_dos_fragmentos_de_ate_25ha_das_areas_nativas_com_mais_de_100ha,
                  'D_fragmentos_ate_50ha_de_fontes_com_mais_de_100ha':distancias_dos_fragmentos_de_ate_50ha_das_areas_nativas_com_mais_de_100ha,
                  'D_fragmentos_ate_25ha_de_fontes_com_mais_de_500ha':distancias_dos_fragmentos_de_ate_25ha_das_areas_nativas_com_mais_de_500ha,
                  'D_fragmentos_ate_50ha_de_fontes_com_mais_de_500ha':distancias_dos_fragmentos_de_ate_50ha_das_areas_nativas_com_mais_de_500ha,
                  'D_fragmentos_ate_100ha_de_fontes_com_mais_de_500ha':distancias_dos_fragmentos_de_ate_100ha_das_areas_nativas_com_mais_de_500ha,
                  'D_fragmentos_ate_25ha_de_fontes_com_mais_de_1000ha':distancias_dos_fragmentos_de_ate_25ha_das_areas_nativas_com_mais_de_1000ha,
                  'D_fragmentos_ate_50ha_de_fontes_com_mais_de_1000ha':distancias_dos_fragmentos_de_ate_50ha_das_areas_nativas_com_mais_de_1000ha,
                  'D_fragmentos_ate_100ha_de_fontes_com_mais_de_1000ha':distancias_dos_fragmentos_de_ate_100ha_das_areas_nativas_com_mais_de_1000ha,
                ...
                'periods': {
                  'D_fragmentos_ate_25ha_de_fontes_com_mais_de_100ha':[ '1986', '1987', '1988', '1989', '1990','1991', '1992', '1993', '1994', '1995', '1996','1997', '1998', '1999', '2000', '2001', '2002','2003', '2004', '2005', '2006', '2007', '2008','2009', '2010', '2011', '2012', '2013', '2014','2015', '2016', '2017', '2018', '2019', '2020','2021' ],
                  'D_fragmentos_ate_50ha_de_fontes_com_mais_de_100ha':[ '1986', '1987', '1988', '1989', '1990','1991', '1992', '1993', '1994', '1995', '1996','1997', '1998', '1999', '2000', '2001', '2002','2003', '2004', '2005', '2006', '2007', '2008','2009', '2010', '2011', '2012', '2013', '2014','2015', '2016', '2017', '2018', '2019', '2020','2021' ],
                  'D_fragmentos_ate_25ha_de_fontes_com_mais_de_500ha':[ '1986', '1987', '1988', '1989', '1990','1991', '1992', '1993', '1994', '1995', '1996','1997', '1998', '1999', '2000', '2001', '2002','2003', '2004', '2005', '2006', '2007', '2008','2009', '2010', '2011', '2012', '2013', '2014','2015', '2016', '2017', '2018', '2019', '2020','2021' ],
                  'D_fragmentos_ate_50ha_de_fontes_com_mais_de_500ha':[ '1986', '1987', '1988', '1989', '1990','1991', '1992', '1993', '1994', '1995', '1996','1997', '1998', '1999', '2000', '2001', '2002','2003', '2004', '2005', '2006', '2007', '2008','2009', '2010', '2011', '2012', '2013', '2014','2015', '2016', '2017', '2018', '2019', '2020','2021' ],
                  'D_fragmentos_ate_100ha_de_fontes_com_mais_de_500ha':[ '1986', '1987', '1988', '1989', '1990','1991', '1992', '1993', '1994', '1995', '1996','1997', '1998', '1999', '2000', '2001', '2002','2003', '2004', '2005', '2006', '2007', '2008','2009', '2010', '2011', '2012', '2013', '2014','2015', '2016', '2017', '2018', '2019', '2020','2021' ],
                  'D_fragmentos_ate_25ha_de_fontes_com_mais_de_1000ha':[ '1986', '1987', '1988', '1989', '1990','1991', '1992', '1993', '1994', '1995', '1996','1997', '1998', '1999', '2000', '2001', '2002','2003', '2004', '2005', '2006', '2007', '2008','2009', '2010', '2011', '2012', '2013', '2014','2015', '2016', '2017', '2018', '2019', '2020','2021' ],
                  'D_fragmentos_ate_50ha_de_fontes_com_mais_de_1000ha':[ '1986', '1987', '1988', '1989', '1990','1991', '1992', '1993', '1994', '1995', '1996','1997', '1998', '1999', '2000', '2001', '2002','2003', '2004', '2005', '2006', '2007', '2008','2009', '2010', '2011', '2012', '2013', '2014','2015', '2016', '2017', '2018', '2019', '2020','2021' ],
                  'D_fragmentos_ate_100ha_de_fontes_com_mais_de_1000ha':[ '1986', '1987', '1988', '1989', '1990','1991', '1992', '1993', '1994', '1995', '1996','1997', '1998', '1999', '2000', '2001', '2002','2003', '2004', '2005', '2006', '2007', '2008','2009', '2010', '2011', '2012', '2013', '2014','2015', '2016', '2017', '2018', '2019', '2020','2021' ],
        ...
        bandsNames: {
          ...
          'D_fragmentos_ate_25ha_de_fontes_com_mais_de_100ha':"frag",
          'D_fragmentos_ate_50ha_de_fontes_com_mais_de_100ha':"frag",
          'D_fragmentos_ate_25ha_de_fontes_com_mais_de_500ha':"frag",
          'D_fragmentos_ate_50ha_de_fontes_com_mais_de_500ha':"frag",
          'D_fragmentos_ate_100ha_de_fontes_com_mais_de_500ha':"frag",
          'D_fragmentos_ate_25ha_de_fontes_com_mais_de_1000ha':"frag",
          'D_fragmentos_ate_50ha_de_fontes_com_mais_de_1000ha':"frag",
          'D_fragmentos_ate_100ha_de_fontes_com_mais_de_1000ha':"frag",
        ...
        ranges: {
          'classes_de_borda':{min: 0,max: 8},
          'classes_de_tamanho':{  min: 0, max: 6},
          ...
          'D_fragmentos_ate_25ha_de_fontes_com_mais_de_100ha':{'min':0,'max':4},
          'D_fragmentos_ate_50ha_de_fontes_com_mais_de_100ha':{'min':0,'max':4},
          'D_fragmentos_ate_25ha_de_fontes_com_mais_de_500ha':{'min':0,'max':4},
          'D_fragmentos_ate_50ha_de_fontes_com_mais_de_500ha':{'min':0,'max':4},
          'D_fragmentos_ate_100ha_de_fontes_com_mais_de_500ha':{'min':0,'max':4},
          'D_fragmentos_ate_25ha_de_fontes_com_mais_de_1000ha':{'min':0,'max':4},
          'D_fragmentos_ate_50ha_de_fontes_com_mais_de_1000ha':{'min':0,'max':4},
          'D_fragmentos_ate_100ha_de_fontes_com_mais_de_1000ha':{'min':0,'max':4},
        ...
        palette: {
          ...
          'classes_de_borda':['#55604B','#FF0001','#32CD32','#19B06F','#6FA8DC','#0B5394','#A64D79','#F54CA9'],
          'classes_de_tamanho':['#aaaaaa','#E50C08', '#FFAA5F','#32CD32','#19B06F','#6FA8DC','#0B5394'],
          ...
          'D_fragmentos_ate_25ha_de_fontes_com_mais_de_100ha':['#aaaaaa','#414927','#FFAA5F', '#FF0001','#F54CA9'],
          'D_fragmentos_ate_50ha_de_fontes_com_mais_de_100ha':['#aaaaaa','#414927','#FFAA5F', '#FF0001','#F54CA9'],
          'D_fragmentos_ate_25ha_de_fontes_com_mais_de_500ha':['#aaaaaa','#414927','#FFAA5F', '#FF0001','#F54CA9'],
          'D_fragmentos_ate_50ha_de_fontes_com_mais_de_500ha':['#aaaaaa','#414927','#FFAA5F', '#FF0001','#F54CA9'],
          'D_fragmentos_ate_100ha_de_fontes_com_mais_de_500ha':['#aaaaaa','#414927','#FFAA5F', '#FF0001','#F54CA9'],
          'D_fragmentos_ate_25ha_de_fontes_com_mais_de_1000ha':['#aaaaaa','#414927','#FFAA5F', '#FF0001','#F54CA9'],
          'D_fragmentos_ate_50ha_de_fontes_com_mais_de_1000ha':['#aaaaaa','#414927','#FFAA5F', '#FF0001','#F54CA9'],
          'D_fragmentos_ate_100ha_de_fontes_com_mais_de_1000ha':['#aaaaaa','#414927','#FFAA5F', '#FF0001','#F54CA9'],
