  ...
  <pipe>
    <rasterrenderer type="paletted" band="1" opacity="1" alphaBand="-1" nodataColor="">
      ...
      <colorPalette>
        ...
        <paletteEntry value="2017" color="#9f2222" label="2017" alpha="255"/>
        <paletteEntry value="2018" color="#9b2226" label="2018" alpha="255"/>
        <paletteEntry value="2019" color="#961b1e" label="2019" alpha="255"/>
        <paletteEntry value="2020" color="#901417" label="2020" alpha="255"/>
        <paletteEntry value="2021" color="#8b0e0f" label="2021" alpha="255"/>
